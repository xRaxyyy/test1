...
function initializeCart() {
    let storedCart = JSON.parse(localStorage.getItem('shoppingCart2'));
...
function removeFromCart(name) {
    ...
    localStorage.setItem('shoppingCart2', JSON.stringify(cart)); // Save updated cart to local storage
...
function initializeCartCounter() {
    const storedCart = JSON.parse(localStorage.getItem('shoppingCart2'));
    const cartCounter = document.getElementById('cart-counter');
...
function addToCart(event) {
    ...
    localStorage.setItem('shoppingCart2', JSON.stringify(cart));
